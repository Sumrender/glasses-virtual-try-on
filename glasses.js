...
<html>
  <head>
    ...
    <!-- main stylesheet: -->
    <link rel="stylesheet" href="JeelizVTOWidget.css" />
  ...
  <body onload="main()">
    <div class="content">
      <div class="header">
        <div class="headerTitle">Glasses Virtual Try-On</div>
      </div>
      ...
      <div id="JeelizVTOWidget">
        ...
        >
          ...
          <button
            onclick="JEELIZVTOWIDGET.load('rayban_round_cuivre_pinkBrownDegrade')"
          >
            Model 2
          </button>
          <button
            onclick="JEELIZVTOWIDGET.load_modelStandalone('glasses3D/glasses1.json')"
          >
            Model 3
          </button>
